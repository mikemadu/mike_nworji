  ...
  <div class="form-container">
    <div id="formSection">
      <form id="applicationForm" method="POST" enctype="multipart/form-data">
        ...
        <!-- ** Michael please remove all 'Required' attributes on all form fields except the ones with asterisks that I have added -->

        <!-- SUB HEADER -->
        <div class="sub-header">
          <div>
            Please fill out the following with black ball pen (<strong>PLEASE PRINT IN BLOCK LETTERS</strong>)
          </div>
        ...
        <div class="section-box">
         ...
         <div class="checkbox-group">
              <label>
                  <input type="checkbox" id="modeDirect" name="modeOfReference[]" value="direct" />
                  DIRECT HIRE
              </label>
              <label>
                  <input type="checkbox" id="modeGwip" name="modeOfReference[]" value="gwip" />
                  GWIP HIRE
              </label>
              <label>
                  <input type="checkbox" id="modeIndirect" name="modeOfReference[]" value="indirect" />
                  PRINCIPAL'S INDIRECT HIRE
              </label>
              <label>
        ...
        <div class="section-box">
          ...
          <div class="personal-container">
            ...
            <div class="personal-left">
              ...
              <div class="form-group">
                <label>Main Address (City Address):<span
              ...
              <div class="form-group inline-fields">
                ...
                <input type="tel" name="phone" style="width: 30%" required/>
              </div>
              ...
              <div class="form-group inline-fields">
                ...
                <input type="text" name="highestEducational" placeholder="College / High schooll / etc..."
                  style="width: 21%" />
              </div>
          ...
          <table>
            ...
            <tr>
              <td>
                <input class="gap" type="text" name="university_name" placeholder="➡ University" /><br />
            ...
            <tr>
              <td>
                <input class="gap" type="text" name="highschool_name" placeholder="➡ High School" /><br />
            ...
            <tr>
              <td>
                <input class="gap" type="text" name="elementary_name" placeholder="➡ Elementary" /><br />
            ...
            <tr>
              <td>
                <input class="gap" type="text" name="technical_name" placeholder="➡ Technical School" /><br />
          ...
          <div class="section-title"><span>REVIEWS (ON-GOING / COMPLETED)</span></div>

          <div class="review-row">
            <div>1. <input type="text" name="review1" /></div>
            <div>
              <label><input type="radio" name="review1_status" value="ongoing" />
                On-Going</label>
              <label><input type="radio" name="review1_status" value="completed" />
                Completed</label>
            </div>
          </div>
          ...
          <div class="review-row">
            ...
            <div>
              <label><input type="radio" name="review2_status" value="ongoing" />
                On-Going</label>
              <label><input type="radio" name="review2_status" value="completed" />
                Completed</label>
            </div>
          </div>
          ...
          <div class="review-row">
            ...
            <div>
              <label><input type="radio" name="review3_status" value="ongoing" />
                On-Going</label>
              <label><input type="radio" name="review3_status" value="completed" />
                Completed</label>
            </div>
          </div>
          ...
          <table>
            ...
            <tr>
              ...
              <td style='padding-top: 24px;'><input type="text" name="exam1_year" /></td>
              <td>5.<input type="text" name="exam5" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam5_year" /></td>
            </tr>

            <tr>
              <td>2.<input type="text" name="exam2" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam2_year" /></td>
              <td>6.<input type="text" name="exam6" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam6_year" /></td>
            </tr>

            <tr>
              <td>3.<input type="text" name="exam3" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam3_year" /></td>
              <td>7.<input type="text" name="exam7" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam7_year" /></td>
            </tr>

            <tr>
              <td>4.<input type="text" name="exam4" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam4_year" /></td>
              <td>8.<input type="text" name="exam8" /></td>
              <td style='padding-top: 24px;'><input type="text" name="exam8_year" /></td>
            </tr>
          </table>
          ...
          <div class="section-box">
            <!-- EDUCATION -->
            <div class="section-title">EDUCATIONAL QUALIFICATIONS (Check the appropreate Box below)</div>
            ...
            <div class="left-space">
              <div class="sub-section">
                ...
                <div class="checkbox-grid">
                  <label><input type="checkbox" name="nursing_qualification[]" value="bsc" />
                    B.Sc. Nursing</label>
                  <label><input type="checkbox" name="nursing_qualification[]" value="diploma_nursing" />
                    Diploma of Nursing</label>
                  <label><input type="checkbox" name="nursing_qualification[]" value="midwifery" />
                    Diploma of Midwifery</label>
                  <label><input type="checkbox" name="nursing_qualification[]" value="masters" />
                    Masters in Nursing</label>
                  <label><input type="checkbox" name="nursing_qualification[]" value="phd" />
                    PhD in Nursing</label>
                  <label>
                    <input type="checkbox" name="nursing_qualification[]" value="other" />
                    Other Diploma:
              ...
              <div class="sub-section">
                ...
                <div class="checkbox-grid">
                  <label><input type="checkbox" name="pt_qualification[]" value="bsc_pt" />
                    B.Sc. Physical Therapist</label>
                  <label><input type="checkbox" name="pt_qualification[]" value="na" />
            ...
            <!-- JOB SPECIALTIES -->
            <div class="section-title">JOB SPECIALTIES / POSITIONS HELD (Check the appropreate Box below)</div>
            <div class="checkbox-grid-1">

              <label>
                <input type="checkbox" name="job_specialty[]" value="er">
                Emergency Room Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="med_surg">
                Medical Surgical Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="general">
                General Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="icu">
                ICU Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="telemetry">
                Telemetry Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="pt">
                Physical Therapist
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="theater">
                Theater / Operation Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="pcu">
                PCU/CVPCU Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="ot">
                Occupational Therapist
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="delivery">
                Delivery Room Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="rehab">
                Rehabilitation Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="ortho">
                Orthopedic Nurse
              </label>

              <label>
                <input type="checkbox" name="job_specialty[]" value="others">
                Others — please specify:
                <input type="text" name="job_specialty_other">
              </label>
            ...
            <!-- PORTFOLIO -->
            <div class="section-title">YOUR PORTFOLIO LEVEL (Check the appropreate Box below)</div>
            <div class="checkbox-grid-2">

              <label>
                <input type="checkbox" name="portfolio[]" value="staff">
                Staff Nurse
              </label>

              <label>
                <input type="checkbox" name="portfolio[]" value="charge">
                Charge Nurse (Nurse Manager during shifts)
              </label>

              <label>
                <input type="checkbox" name="portfolio[]" value="senior">
                Senior Nurse
              </label>

              <label>
                <input type="checkbox" name="portfolio[]" value="director">
                Nursing Director
              </label>

              <label>
                <input type="checkbox" name="portfolio[]" value="head">
                Head Nurse
              </label>

              <label>
                <input type="checkbox" name="portfolio[]" value="sister">
                Nursing Sister
              </label>
            ...
            <table>
              ...
              <tr>
                ...
                <td><input type="text" class="gap" name="prc_issued" /></td>
                <td><input type="text" class="gap" name="prc_expiry" /></td>
              </tr>
              <tr>
                <td>➡ SSS/GSIS</td>
                <td><input type="text" class="gap" name="sss_number" /></td>
                <td><input type="text" class="gap" name="sss_issued" /></td>
                <td><input type="text" class="gap" name="sss_expiry" /></td>
              </tr>
              <tr>
                ...
                <td>
                  <input type="text" class="gap" name="driver_issued" />
                </td>
                <td>
                  <input type="text" class="gap" name="driver_expiry" />
                </td>
              </tr>
              <tr>
                <td>➡ Passport</td>
                ...
                <td>
                  <input type="text" class="gap" name="passport_issued" />
                </td>
                <td>
                  <input type="text" class="gap" name="passport_expiry" />
                </td>
              </tr>
              <tr>
          ...
          <div class="section-box">
            ...
            <p>
              Spouse’s Birth Date :
              <input class="line-dash full" name="spouse_birthdate" />
            </p>
